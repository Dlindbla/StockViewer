...
public class GraphGenerator {
    ...
    public ArrayList<Comparable> getxIndexList(){ return xIndexList;}
    ...
    public void populateSeries(ArrayList<PlottableObject> plottableObjects){
        ...
        //iterate over all the plottable objects and create XY.ChartSeries items out of them
    ...
    public XYChart.Series<Number, Number> createXYSeries(PlottableObject plottableObject) {
        ...
        for (var item : plottableObject.getItems()) {
            ...
            tempTick.setExtraValue(new Pair<>(plottableObject.getName(),
                    plottableObject.getCurrency()));
